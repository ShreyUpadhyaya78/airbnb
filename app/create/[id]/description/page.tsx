...
<Label>Title</Label>
<Input placeholder="Short and simple..." name="title" required type="text"/>
            </div>
            <div className="flex flex-col gap-y-2">
<Label>Description</Label>
<Textarea placeholder="Please describe your home..." name="description" required />
            </div>
            <div className="flex flex-col gap-y-2">
                <Label>Price</Label>
                <Input required placeholder="Price per Night in USD" type="number" name="price" min={10}/>
            </div>
            <div className="flex flex-col gap-y-2">
                <Label>Image</Label>
